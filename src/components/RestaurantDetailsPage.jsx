...
import mapImagesToCarouselFormat from '../utils/detailsPage';
import TrendingCarousel from './home/TrendingCarousel';
import NavFilterDetails from './NavFilterDetails';
import HorizontalScrollBar from './HorizontalScrollBar';

class DetailsRecipePage extends React.Component {
  constructor(props) {
    super(props);
    console.log(props);
    const images = mapImagesToCarouselFormat(props);
    const {
      name,
      sodium,
      protein,
    ...
    this.state = {
      ...
      portions,
      recipeHistory,
      similarRecipes: [{ id: 1, name: 'Test Recipe', imageUrl: 'https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto,fl_lossy/wp-cms/uploads/2017/06/i-1-sonic-burger.jpg', linkUrl: '/' },
        { id: 2, name: 'Test 2', imageUrl: 'https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto,fl_lossy/wp-cms/uploads/2017/06/i-1-sonic-burger.jpg', linkUrl: '/' },
        { id: 3, name: 'Test 3', imageUrl: 'https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto,fl_lossy/wp-cms/uploads/2017/06/i-1-sonic-burger.jpg', linkUrl: '/' },
        { id: 4, name: 'Test 4', imageUrl: 'https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto,fl_lossy/wp-cms/uploads/2017/06/i-1-sonic-burger.jpg', linkUrl: '/' },
      ],
    };
  }
